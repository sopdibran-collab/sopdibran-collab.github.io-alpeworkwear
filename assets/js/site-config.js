...
window.ALPE_CONFIG = {
  ...
  responseTime: 'Réponse sous 1 à 2 jours ouvrables selon disponibilité.',
  productionDelay: '2 à 4 semaines selon quantités et finitions (options rush sur demande).',
  serviceAreas: ['Suisse', 'Genève', 'Lausanne', 'Zurich', 'Berne', 'Bâle', 'Valais', 'Vaud'],
  knowsAbout: [
    'vêtements de travail personnalisés',
    'vêtements d\'entreprise suisse',
    'textile personnalisé',
    'textile personnalisé Vaud',
    'textile personnalisé Valais',
    'broderie professionnelle',
    'broderies professionnelles',
    'sérigraphie textile',
    'workwear Switzerland',
    'workwear branding',
    'habits de travail montagne',
    'workwear B2B',
    'haute visibilité EN ISO 20471',
  ],
};
